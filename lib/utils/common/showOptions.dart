...
void showOptionParameter(BuildContext context, List<Purpose> listOption,void Function(bool) callback,void Function(Purpose) callback2) {
                  ...
                  Row(
                    ...
                    children: [
                      const Align(
                        ...
                        child: Text('Tipos de pausas:',style:TextStyle(fontSize:24)),
                      ),
                      Align(
                          ...
                          GestureDetector(
                            onTap: (){
                              ...
                              setState(() {
                                ...
                                GetStorage().write('totalTime', (element.estimatedTime!*60 ).toInt());
                                callback2(element);
                              ...
                              children: [
                                Row(
                                  children: [
                                    8.width,
                                    Text(e.purpose,
                                        style: primaryTextStyle(color: mainColorBlue,weight: fontWeightBoldGlobal)),
                                  ],
                                ),
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("${DateFormat('HH:mm').format(e.breakIn!.date )} - ${DateFormat('HH:mm').format(e.breakOut!.date)}" ?? '',
                                      style: primaryTextStyle(color: mainColorBlue,weight: fontWeightBoldGlobal)),
